...
import { Search, Users, X, ChevronRight, Eye, Calendar, AlertCircle, Vote, Flame } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-white mb-2">
            {isSearching ? 'Search Results' : 'Vote for Your Favorite Candidate'}
          </h1>
          <p className="text-white/60 text-sm md:text-base max-w-2xl mx-auto">
            {isSearching 
              ? `Found ${filteredCandidates.length} candidates matching "${searchQuery}"`
              : 'Support your favorite contestant by casting your vote today'
            }
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-white/60 text-sm">
              {searchQuery 
                ...
                : 'Check back soon for new candidates to vote for.'
              }
            </p>
          </div>
        )}
