            ...
            <div className="p-4 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-xl font-semibold transition-opacity flex items-center justify-center gap-2"
                >
                  {copied ? (
                    <>
              ...
              <p className="text-[10px] text-white/20 text-center">
                Click Download Image or Copy Link to share the card
              </p>
            </div>
          </motion.div>
        </motion.div>
