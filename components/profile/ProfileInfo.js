      ...
      <div className="flex flex-row flex-wrap items-center gap-2 md:gap-4 mb-4">
        <div className="flex items-center gap-2">
          ...
          {profile.role === 'celebrity' && (
            <span className="px-2 py-0.5 bg-gradient-to-r from-[#C58B2A] to-[#A96F1F] text-white text-[10px] md:text-xs rounded-full">
              Celebrity
            </span>
          )}
          {isAdminAndOwner && (
      ...
      {profile.website && (
        <div className="flex justify-center mb-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1 text-[10px] md:text-xs text-[#C58B2A] hover:text-[#A96F1F] transition-colors"
          >
